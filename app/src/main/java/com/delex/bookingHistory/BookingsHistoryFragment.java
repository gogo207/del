 ...
 * 예약 세부 정보 제공하는 클래스
 * 이 클래스는 우리가 예약을 할 수있는 예약 내역을 제공하는 데 사용됩니다.
 *
 * @author 3embed
 * @since 3 Jan 2017.
 */
public class BookingsHistoryFragment extends ParentFragment implements View.OnClickListener {
    ...
    /**
     * 이 메소드는 우리의 프래그먼트가 우리의 액티비티에 붙어있을 때 호출된다.
     *
    ...
    public void onResume() {
        ...
        if (Utility.isNetworkAvailable(getActivity())) {  //인터넷 연결 되있을때 예약 세부 정보 데이터 요청
