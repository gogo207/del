...
import com.delex.chat_module.Adapters.ChatlistAdapter;
import com.delex.chat_module.Callbacks.DatabaseCallbackHandler;
import com.delex.chat_module.ModelClasses.Chatlist_item;
import com.delex.chat_module.TopSnackBar.TSnackbar;
import com.delex.chat_module.Utilities.ChatsSorter;
import com.delex.chat_module.Utilities.CustomLinearLayoutManager;
import com.delex.chat_module.Utilities.RecyclerItemClickListener;
...
public class Chatlist extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatData = new ArrayList<Chatlist_item>();
        ...
        searchView.setBackgroundColor(ContextCompat.getColor(Chatlist.this, R.color.white));
        ...
        DatabaseCallbackHandler handler = new DatabaseCallbackHandler(Chatlist.this) {
            ...
            public void execute(DataSnapshot childDataSnapshot) throws JSONException {
                ...
                long count = Long.parseLong(String.valueOf(childDataSnapshot.child("unreadMessageCount").getValue())) ;
            ...
            AuthUI.getInstance().signOut(this)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            Intent i = new Intent(Chatlist.this, FireBaseChatActivity.class);
                            startActivity(i);
                            finish();
                        }
                    });
