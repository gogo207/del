...
public class Single_ShipemntDetails_Pojo {
    ...
    private SingleLocationPojo location;
    ...
    public SingleLocationPojo getLocation ()
    {
        return location;
    }

    public void setLocation (SingleLocationPojo location)
    {
