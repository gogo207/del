...
public class ForgotPasswordModel {
    ...
    public void forgotPassService(final String phone_Mail, final int mobile_email_type){
        ...
        try {
            ...
            OkHttp3Connection.doOkHttp3Connection("",sessionManager.getLanguageId(), Constants.FORGOTPASS, OkHttp3Connection.Request_type.POST, jsonObject, new OkHttp3Connection.OkHttp3RequestCallback() {
                @Override
...
//                            et_phone_mail.setError(null);
    ...
    public void getVerificationCode(final String phone_Mail, final int mobile_email_type){
        try {
            ...
            jsonObject.put("ent_type", mobile_email_type);
            OkHttp3Connection.doOkHttp3Connection("",sessionManager.getLanguageId(), Constants.FORGOTPASSWORD, OkHttp3Connection.Request_type.POST, jsonObject, new OkHttp3Connection.OkHttp3RequestCallback() {
                @Override
