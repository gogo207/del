...
import com.delex.chat_module.Utilities.TextDrawable;
import com.delex.chat_module.Utilities.Utilities;
import com.delex.chat_module.ViewHolders.ViewHolderChatlist;
import com.delex.servicesMgr.Chatlist;
...
public class ChatlistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private ArrayList<Chatlist_item> mOriginalListData = new ArrayList<Chatlist_item>();
...
//            vh.newMessage.setTypeface(tf, Typeface.NORMAL);
    ...
    private ArrayList<Chatlist_item> getFilteredResults(String constraint) {
        ArrayList<Chatlist_item> results = new ArrayList<Chatlist_item>();
