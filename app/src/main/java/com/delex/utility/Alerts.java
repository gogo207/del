...
import com.delex.customer.R;import com.delex.servicesMgr.FireBaseMessageReceiver;
...
public class Alerts extends Activity {
    ...
    public void showNetworkAlert(final Context context)
    {
        ...
        boolean isbkrnd= FireBaseMessageReceiver.isApplicationSentToBackground(context);
    ...
    public void showNetworkAlert1(final Context context, boolean check)
    {
        Dialog dialog;
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(context);
