package com.delex.numberPicker;
...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.layout_number_picker_with_selector_wheel, this, true);
...
//        }
    ...
    public void setDisplayedValues(String[] displayedValues) {
        Utility.printLog(TAG+"setDisplayedValues size "+displayedValues.length);
     ...
     */
    private class SetSelectionCommand implements Runnable {
