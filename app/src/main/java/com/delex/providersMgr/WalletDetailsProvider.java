...
public class WalletDetailsProvider
{
    ...
    public void getWalletDetails()
    {
        try
        {
            OkHttp3Connection.doOkHttp3Connection(sessionMgr.getSession(),sessionMgr.getLanguageId(), Constants.WALLET_DETAILS,
    ...
    public void rechargeWalletApi()
    {
        try
        {
            ...
            OkHttp3Connection.doOkHttp3Connection(sessionMgr.getSession(),sessionMgr.getLanguageId(), Constants.RECHARGE_WALLET,
