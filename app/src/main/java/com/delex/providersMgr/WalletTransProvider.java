...
import com.delex.pojos.WalletTransPojo;
...
public class WalletTransProvider
{
    ...
    public void getTransactionsHistory(final boolean isToLoadMore)
    {
        try
        {
            ...
            String url = Constants.WALLET_TRANSACTIONS+sessionMgr.getSid()+"/2/"+pageIndexTemp;
            //Log.d(TAG, "getTransactionsHistory  url: "+url);
            OkHttp3Connection.doOkHttp3Connection(sessionMgr.getSession(),sessionMgr.getLanguageId(), url,
